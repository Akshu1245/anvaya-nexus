...
This GitHub repository is the only source of truth. Do not introduce a parallel visual prototype, backend, database, authentication system, or source repository.
